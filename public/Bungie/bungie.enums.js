...
//originally interfaces.js from bungie-api-ts/destiny2 package version 4.16.0
...
const DestinyProgressionStepDisplayEffect = { None: 0, Character: 1, Item: 2 };
const DestinyScope = { Profile: 0, Character: 1 };
...
const DestinyVendorProgressionType = { Default: 0, Ritual: 1, NoSeasonalRefresh: 2 };
...
const DestinyActivityModeCategory = { None: 0, PvE: 1, PvP: 2, PvECompetitive: 3 };
...
const BucketScope = { Character: 0, Account: 1 };
const BucketCategory = { Invisible: 0, Item: 1, Currency: 2, Equippable: 3, Ignored: 4 };
const ItemLocation = { Unknown: 0, Inventory: 1, Vault: 2, Vendor: 3, Postmaster: 4 };
...
const VendorDisplayCategorySortOrder = { Default: 0, SortByTier: 1 };
const DestinyVendorInteractionRewardSelection = { None: 0, One: 1, All: 2 };
const DestinyVendorReplyType = { Accept: 0, Decline: 1, Complete: 2 };
...
const DestinyItemSortType = { ItemId: 0, Timestamp: 1, StackSize: 2 };
const DestinyVendorItemRefundPolicy = {
  NotRefundable: 0,
  DeletesItem: 1,
  RevokesLicense: 2,
};
const SocketTypeActionType = { InsertPlug: 0, InfuseItem: 1, ReinitializeSocket: 2 };
...
const DamageType = { None: 0, Kinetic: 1, Arc: 2, Thermal: 3, Void: 4, Raid: 5, Stasis: 6 };
...
const DestinyObjectiveGrantStyle = { WhenIncomplete: 0, WhenComplete: 1, Always: 2 };
const DestinyStatAggregationType = { CharacterAverage: 0, Character: 1, Item: 2 };
const DestinyStatCategory = { Gameplay: 0, Weapon: 1, Defense: 2, Primary: 3 };
...
const DestinyGender = { Male: 0, Female: 1, Unknown: 2 };
...
const DestinyPresentationScreenStyle = { Default: 0, CategorySets: 1, Badge: 2 };
const TierType = {
  Unknown: 0,
  Currency: 1,
  Basic: 2,
...
const EquippingItemBlockAttributes = { None: 0, EquipOnAcquire: 1 };
const DestinyAmmunitionType = { None: 0, Primary: 1, Special: 2, Heavy: 3, Unknown: 4 };
const DestinyClass = { Titan: 0, Hunter: 1, Warlock: 2, Unknown: 3 };
const DestinyRewardSourceCategory = { None: 0, Activity: 1, Vendor: 2, Aggregate: 3 };
const PlugUiStyles = { None: 0, Masterwork: 1 };
...
const ItemPerkVisibility = { Visible: 0, Disabled: 1, Hidden: 2 };
const DestinyBreakerType = { None: 0, ShieldPiercing: 1, Disruption: 2, Stagger: 3 };
...
const DestinyVendorFilter = { None: 0, ApiPurchasable: 1 };
...
const PeriodType = { None: 0, Daily: 1, AllTime: 2, Activity: 3 };
...
const ComponentPrivacySetting = { None: 0, Public: 1, Private: 2 };
...
const DestinyPresentationNodeState = { None: 0, Invisible: 1, Obscured: 2 };
...
const DestinyRace = { Human: 0, Awoken: 1, Exo: 2, Unknown: 3 };
...
const DestinySocketArrayType = { Default: 0, Intrinsic: 1 };
...
const AwaType = { None: 0, InsertPlugs: 1 };
const AwaUserSelection = { None: 0, Rejected: 1, Approved: 2 };
const AwaResponseReason = { None: 0, Answered: 1, TimedOut: 2, Replaced: 3 };
